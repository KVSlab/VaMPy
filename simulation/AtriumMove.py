...
def create_bcs(NS_expressions, flow_rate_type, dynamic_mesh, x_, cardiac_cycle, backflow_facets, mesh, mesh_path, nu, t,
    ...
    if dynamic_mesh:
        ...
        wall_counter = Surface_counter(points, cardiac_cycle, flow_rate_type, element=V.ufl_element())
...
def temporal_hook(mesh, id_wall, id_out, cardiac_cycle, dt, t, save_solution_frequency, u_, id_in, tstep, newfolder,
                  eval_dict, viz_b, q_,
                  dump_probe_frequency, p_, save_solution_at_tstep, nu, D_mitral, U, u_mean0, u_mean1, u_mean2,
                  save_flow_metrics_frequency, save_volume_frequency, save_solution_frequency_xdmf, u_vec, viz_U,
                  boundary, outlet_area, **NS_namespace):
